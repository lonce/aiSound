...
Encoder.prototype.setDirection = function(azimuth, elevation) {
  ...
  this._channelGain[0].gain.value = __WEBPACK_IMPORTED_MODULE_0__tables_js__["MAX_RE_WEIGHTS"][this._spreadIndex][0];
  for (let i = 1; i <= this._ambisonicOrder; i++) {
    let degreeWeight = __WEBPACK_IMPORTED_MODULE_0__tables_js__["MAX_RE_WEIGHTS"][this._spreadIndex][i];
    for (let j = -i; j <= i; j++) {
      let acnChannel = (i * i) + i + j;
      let elevationIndex = i * (i + 1) / 2 + Math.abs(j) - 1;
      let val = __WEBPACK_IMPORTED_MODULE_0__tables_js__["SPHERICAL_HARMONICS"][1][elevation][elevationIndex];
      if (j != 0) {
        let azimuthIndex = __WEBPACK_IMPORTED_MODULE_0__tables_js__["SPHERICAL_HARMONICS_MAX_ORDER"] + j - 1;
        if (j < 0) {
          azimuthIndex = __WEBPACK_IMPORTED_MODULE_0__tables_js__["SPHERICAL_HARMONICS_MAX_ORDER"] + j;
        }
        val *= __WEBPACK_IMPORTED_MODULE_0__tables_js__["SPHERICAL_HARMONICS"][0][azimuth][azimuthIndex];
      }
...
Encoder.validateAmbisonicOrder = function(ambisonicOrder) {
  if (isNaN(ambisonicOrder) || ambisonicOrder == undefined) {
    ...
    ambisonicOrder = 1;
  } else if (ambisonicOrder > __WEBPACK_IMPORTED_MODULE_0__tables_js__["SPHERICAL_HARMONICS_MAX_ORDER"]) {
    __WEBPACK_IMPORTED_MODULE_1__utils_js__["a" /* default */].log('Error: Unable to render ambisonic order',
    options.ambisonicOrder, '(Max order is',
    __WEBPACK_IMPORTED_MODULE_0__tables_js__["SPHERICAL_HARMONICS_MAX_ORDER"], ')\nUsing max order instead.');
    options.ambisonicOrder = __WEBPACK_IMPORTED_MODULE_0__tables_js__["SPHERICAL_HARMONICS_MAX_ORDER"];
  }
...
//import * as foo from '../node_modules/omnitone/build/omnitone.js'

//const Omnitone = {};
//Omnitone.Omnitone= foo;
console.log("Omnitone is " + __WEBPACK_IMPORTED_MODULE_0__node_modules_omnitone_build_omnitone_esm_js__["a" /* default */]);
//const Omnitone={}
//Omnitone.Omnitone=foo
...
function Listener(context, options) {
  ...
  if (this._ambisonicOrder == 1) {
    var foo=__WEBPACK_IMPORTED_MODULE_0__node_modules_omnitone_build_omnitone_esm_js__["a" /* default */];
...
/* harmony export (immutable) */ __webpack_exports__["SPHERICAL_HARMONICS"] = SPHERICAL_HARMONICS;
...
/* harmony export (immutable) */ __webpack_exports__["SPHERICAL_HARMONICS_AZIMUTH_RESOLUTION"] = SPHERICAL_HARMONICS_AZIMUTH_RESOLUTION;
...
/* harmony export (immutable) */ __webpack_exports__["SPHERICAL_HARMONICS_ELEVATION_RESOLUTION"] = SPHERICAL_HARMONICS_ELEVATION_RESOLUTION;
...
/* harmony export (immutable) */ __webpack_exports__["SPHERICAL_HARMONICS_MAX_ORDER"] = SPHERICAL_HARMONICS_MAX_ORDER;
...
/* harmony export (immutable) */ __webpack_exports__["MAX_RE_WEIGHTS"] = MAX_RE_WEIGHTS;



/** @type {Number} */
const MAX_RE_WEIGHTS_RESOLUTION = MAX_RE_WEIGHTS.length;
/* harmony export (immutable) */ __webpack_exports__["MAX_RE_WEIGHTS_RESOLUTION"] = MAX_RE_WEIGHTS_RESOLUTION;
...
"use strict";
/* unused harmony export Directivity */
...
"use strict";
/* unused harmony export Attenuation */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_js__ = __webpack_require__(0);
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
...
"use strict";
/* unused harmony export LateReflections */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_js__ = __webpack_require__(0);
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
...
"use strict";
/* unused harmony export EarlyReflections */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_js__ = __webpack_require__(0);
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "ResonanceAudio", function() { return __WEBPACK_IMPORTED_MODULE_0__resonance_audio_js__["a"]; });
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
...
__WEBPACK_IMPORTED_MODULE_0__resonance_audio_js__["a" /* default */].Tables = __WEBPACK_IMPORTED_MODULE_9__tables_js__
...
"use strict";
/* unused harmony export ResonanceAudio */
