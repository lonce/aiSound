 ...
 * limitations under the License.
 */
function s(A,t){void 0==t&&(t={}),void 0==t.ambisonicOrder&&(t.ambisonicOrder=n.a.DEFAULT_AMBISONIC_ORDER),void 0==t.azimuth&&(t.azimuth=n.a.DEFAULT_AZIMUTH),void 0==t.elevation&&(t.elevation=n.a.DEFAULT_ELEVATION),void 0==t.sourceWidth&&(t.sourceWidth=n.a.DEFAULT_SOURCE_WIDTH),this._context=A,this.input=A.createGain(),this._channelGain=[],this._merger=void 0,this.output=A.createGain(),this.setAmbisonicOrder(t.ambisonicOrder),this._azimuth=t.azimuth,this._elevation=t.elevation,this.setSourceWidth(t.sourceWidth)}s.prototype.setAmbisonicOrder=function(A){this._ambisonicOrder=s.validateAmbisonicOrder(A),this.input.disconnect();for(let e=0;e<this._channelGain.length;e++)this._channelGain[e].disconnect();void 0!=this._merger&&this._merger.disconnect(),delete this._channelGain,delete this._merger;let t=(this._ambisonicOrder+1)*(this._ambisonicOrder+1);this._merger=this._context.createChannelMerger(t),this._channelGain=new Array(t);for(let e=0;e<t;e++)this._channelGain[e]=this._context.createGain(),this.input.connect(this._channelGain[e]),this._channelGain[e].connect(this._merger,0,e);this._merger.connect(this.output)},s.prototype.setDirection=function(A,t){(void 0==A||isNaN(A))&&(A=n.a.DEFAULT_AZIMUTH),(void 0==t||isNaN(t))&&(t=n.a.DEFAULT_ELEVATION),this._azimuth=A,this._elevation=t,(A=Math.round(A%360))<0&&(A+=360),t=Math.round(Math.min(90,Math.max(-90,t)))+90,this._channelGain[0].gain.value=i.MAX_RE_WEIGHTS[this._spreadIndex][0];for(let e=1;e<=this._ambisonicOrder;e++){let n=i.MAX_RE_WEIGHTS[this._spreadIndex][e];for(let s=-e;s<=e;s++){let o=e*e+e+s,r=e*(e+1)/2+Math.abs(s)-1,a=i.SPHERICAL_HARMONICS[1][t][r];if(0!=s){let t=i.SPHERICAL_HARMONICS_MAX_ORDER+s-1;s<0&&(t=i.SPHERICAL_HARMONICS_MAX_ORDER+s),a*=i.SPHERICAL_HARMONICS[0][A][t]}this._channelGain[o].gain.value=a*n}}},s.prototype.setSourceWidth=function(A){this._spreadIndex=Math.min(359,Math.max(0,Math.round(A))),this.setDirection(this._azimuth,this._elevation)},s.validateAmbisonicOrder=function(A){return isNaN(A)||void 0==A?(n.a.log("Error: Invalid ambisonic order",options.ambisonicOrder,"\nUsing ambisonicOrder=1 instead."),A=1):A<1?(n.a.log("Error: Unable to render ambisonic order",options.ambisonicOrder,"(Min order is 1)","\nUsing min order instead."),A=1):A>i.SPHERICAL_HARMONICS_MAX_ORDER&&(n.a.log("Error: Unable to render ambisonic order",options.ambisonicOrder,"(Max order is",i.SPHERICAL_HARMONICS_MAX_ORDER,")\nUsing max order instead."),options.ambisonicOrder=i.SPHERICAL_HARMONICS_MAX_ORDER),A},t.a=s},function(A,t,e){"use strict";var i=e(12),n=e(1),s=e(0);function o(A,t){if(void 0==t&&(t={}),void 0==t.ambisonicOrder&&(t.ambisonicOrder=s.a.DEFAULT_AMBISONIC_ORDER),void 0==t.position&&(t.position=s.a.DEFAULT_POSITION.slice()),void 0==t.forward&&(t.forward=s.a.DEFAULT_FORWARD.slice()),void 0==t.up&&(t.up=s.a.DEFAULT_UP.slice()),this.position=new Float32Array(3),this._tempMatrix3=new Float32Array(9),this._ambisonicOrder=n.a.validateAmbisonicOrder(t.ambisonicOrder),this._context=A,1==this._ambisonicOrder){i.a;this._renderer=i.a.createFOARenderer(A,{})}else this._ambisonicOrder>1&&(this._renderer=i.a.createHOARenderer(A,{ambisonicOrder:this._ambisonicOrder}));this.input=A.createGain(),this.output=A.createGain(),this.ambisonicOutput=A.createGain();let e=this;this._renderer.initialize().then(function(){e.input.connect(e._renderer.input),e._ambisonicOrder>1?e._renderer._hoaRotator.output.connect(e.ambisonicOutput):e._renderer._foaRotator.output.connect(e.ambisonicOutput),e._renderer.output.connect(e.output)}),this.setOrientation(t.forward[0],t.forward[1],t.forward[2],t.up[0],t.up[1],t.up[2])}
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
function r(A,t){void 0==t&&(t={}),void 0==t.position&&(t.position=o.a.DEFAULT_POSITION.slice()),void 0==t.forward&&(t.forward=o.a.DEFAULT_FORWARD.slice()),void 0==t.up&&(t.up=o.a.DEFAULT_UP.slice()),void 0==t.minDistance&&(t.minDistance=o.a.DEFAULT_MIN_DISTANCE),void 0==t.maxDistance&&(t.maxDistance=o.a.DEFAULT_MAX_DISTANCE),void 0==t.rolloff&&(t.rolloff=o.a.DEFAULT_ROLLOFF),void 0==t.gain&&(t.gain=o.a.DEFAULT_SOURCE_GAIN),void 0==t.alpha&&(t.alpha=o.a.DEFAULT_DIRECTIVITY_ALPHA),void 0==t.sharpness&&(t.sharpness=o.a.DEFAULT_DIRECTIVITY_SHARPNESS),void 0==t.sourceWidth&&(t.sourceWidth=o.a.DEFAULT_SOURCE_WIDTH),this._scene=A,this._position=t.position,this._forward=t.forward,this._up=t.up,this._dx=new Float32Array(3),this._right=o.a.crossProduct(this._forward,this._up);let e=A._context;this.input=e.createGain(),this._directivity=new i.a(e,{alpha:t.alpha,sharpness:t.sharpness}),this._toEarly=e.createGain(),this._toLate=e.createGain(),this._attenuation=new n.a(e,{minDistance:t.minDistance,maxDistance:t.maxDistance,rolloff:t.rolloff}),this._encoder=new s.a(e,{ambisonicOrder:A._ambisonicOrder,sourceWidth:t.sourceWidth}),this.input.connect(this._toLate),this._toLate.connect(A._room.late.input),this.input.connect(this._attenuation.input),this._attenuation.output.connect(this._toEarly),this._toEarly.connect(A._room.early.input),this._attenuation.output.connect(this._directivity.input),this._directivity.output.connect(this._encoder.input),this._encoder.output.connect(A._listener.input),this.setPosition(t.position[0],t.position[1],t.position[2]),this.input.gain.value=t.gain}r.prototype.setPosition=function(A,t,e){this._position[0]=A,this._position[1]=t,this._position[2]=e;let i=function(A){let t=1;A>o.a.EPSILON_FLOAT&&(t=1-A/o.a.SOURCE_MAX_OUTSIDE_ROOM_DISTANCE,t=Math.max(0,Math.min(1,t)));return t}(this._scene._room.getDistanceOutsideRoom(this._position[0],this._position[1],this._position[2]));this._toLate.gain.value=i,this._toEarly.gain.value=i,this._update()},r.prototype._update=function(){for(let i=0;i<3;i++)this._dx[i]=this._position[i]-this._scene._listener.position[i];let A=Math.sqrt(this._dx[0]*this._dx[0]+this._dx[1]*this._dx[1]+this._dx[2]*this._dx[2]);A>0&&(this._dx[0]/=A,this._dx[1]/=A,this._dx[2]/=A);let t=Math.atan2(-this._dx[0],this._dx[2])*o.a.RADIANS_TO_DEGREES,e=Math.atan2(this._dx[1],Math.sqrt(this._dx[0]*this._dx[0]+this._dx[2]*this._dx[2]))*o.a.RADIANS_TO_DEGREES;this._attenuation.setDistance(A),this._directivity.computeAngle(this._forward,this._dx),this._encoder.setDirection(t,e)},r.prototype.setRolloff=function(A){this._attenuation.setRolloff(A)},r.prototype.setMinDistance=function(A){this._attenuation.minDistance=A},r.prototype.setMaxDistance=function(A){this._attenuation.maxDistance=A},r.prototype.setGain=function(A){this.input.gain.value=A},r.prototype.setOrientation=function(A,t,e,i,n,s){this._forward[0]=A,this._forward[1]=t,this._forward[2]=e,this._up[0]=i,this._up[1]=n,this._up[2]=s,this._right=o.a.crossProduct(this._forward,this._up)},r.prototype.setFromMatrix=function(A){this._right[0]=A.elements[0],this._right[1]=A.elements[1],this._right[2]=A.elements[2],this._up[0]=A.elements[4],this._up[1]=A.elements[5],this._up[2]=A.elements[6],this._forward[0]=A.elements[8],this._forward[1]=A.elements[9],this._forward[2]=A.elements[10],this._right=o.a.normalizeVector(this._right),this._up=o.a.normalizeVector(this._up),this._forward=o.a.normalizeVector(this._forward),this.setPosition(A.elements[12],A.elements[13],A.elements[14])},r.prototype.setSourceWidth=function(A){this._encoder.setSourceWidth(A),this.setPosition(this._position[0],this._position[1],this._position[2])},r.prototype.setDirectivityPattern=function(A,t){this._directivity.setPattern(A,t),this.setPosition(this._position[0],this._position[1],this._position[2])},t.a=r},function(A,t,e){"use strict";var i=e(0);
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function n(A,t){void 0==t&&(t={}),void 0==t.alpha&&(t.alpha=i.a.DEFAULT_DIRECTIVITY_ALPHA),void 0==t.sharpness&&(t.sharpness=i.a.DEFAULT_DIRECTIVITY_SHARPNESS),this._context=A,this._lowpass=A.createBiquadFilter(),this._lowpass.type="lowpass",this._lowpass.Q.value=0,this._lowpass.frequency.value=.5*A.sampleRate,this._cosTheta=0,this.setPattern(t.alpha,t.sharpness),this.input=this._lowpass,this.output=this._lowpass}n.prototype.computeAngle=function(A,t){let e=i.a.normalizeVector(A),n=i.a.normalizeVector(t),s=1;if(this._alpha>i.a.EPSILON_FLOAT){let A=e[0]*n[0]+e[1]*n[1]+e[2]*n[2];s=1-this._alpha+this._alpha*A,s=Math.pow(Math.abs(s),this._sharpness)}this._lowpass.frequency.value=.5*this._context.sampleRate*s},n.prototype.setPattern=function(A,t){this._alpha=Math.min(1,Math.max(0,A)),this._sharpness=Math.max(1,t),this.computeAngle([this._cosTheta*this._cosTheta,0,0],[1,0,0])},t.a=n},function(A,t,e){"use strict";var i=e(0);
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function n(A,t){void 0==t&&(t={}),void 0==t.minDistance&&(t.minDistance=i.a.DEFAULT_MIN_DISTANCE),void 0==t.maxDistance&&(t.maxDistance=i.a.DEFAULT_MAX_DISTANCE),void 0==t.rolloff&&(t.rolloff=i.a.DEFAULT_ATTENUATION_ROLLOFF),this.minDistance=t.minDistance,this.maxDistance=t.maxDistance,this.setRolloff(t.rolloff),this._gainNode=A.createGain(),this.setDistance(t.maxDistance),this.input=this._gainNode,this.output=this._gainNode}n.prototype.setDistance=function(A){let t=1;if("logarithmic"==this._rolloff){if(A>this.maxDistance)t=0;else if(A>this.minDistance){let e=this.maxDistance-this.minDistance;if(e>i.a.EPSILON_FLOAT){let i=1/(e+1);t=(1/(A-this.minDistance+1)-i)/(1-i)}}}else if("linear"==this._rolloff)if(A>this.maxDistance)t=0;else if(A>this.minDistance){let e=this.maxDistance-this.minDistance;e>i.a.EPSILON_FLOAT&&(t=(this.maxDistance-A)/e)}this._gainNode.gain.value=t},n.prototype.setRolloff=function(A){let t=~i.a.ATTENUATION_ROLLOFFS.indexOf(A);void 0!=A&&t?A=A.toString().toLowerCase():(t||i.a.log('Invalid rolloff model ("'+A+'"). Using default: "'+i.a.DEFAULT_ATTENUATION_ROLLOFF+'".'),A=i.a.DEFAULT_ATTENUATION_ROLLOFF),this._rolloff=A},t.a=n},function(A,t,e){"use strict";var i=e(8),n=e(9),s=e(0);
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
function o(A){let t={};for(let e in s.a.DEFAULT_ROOM_MATERIALS)s.a.DEFAULT_ROOM_MATERIALS.hasOwnProperty(e)&&(t[e]=s.a.ROOM_MATERIAL_COEFFICIENTS[s.a.DEFAULT_ROOM_MATERIALS[e]]);void 0==A&&(A={},Object.assign(A,s.a.DEFAULT_ROOM_MATERIALS));for(let e in s.a.DEFAULT_ROOM_MATERIALS)s.a.DEFAULT_ROOM_MATERIALS.hasOwnProperty(e)&&A.hasOwnProperty(e)?A[e]in s.a.ROOM_MATERIAL_COEFFICIENTS?t[e]=s.a.ROOM_MATERIAL_COEFFICIENTS[A[e]]:s.a.log('Material "'+A[e]+'" on wall "'+e+'" not found. Using "'+s.a.DEFAULT_ROOM_MATERIALS[e]+'".'):s.a.log('Wall "'+e+'" is not defined. Default used.');return t}function r(A){void 0==A&&(A={});for(let t in s.a.DEFAULT_ROOM_DIMENSIONS)A.hasOwnProperty(t)||(A[t]=s.a.DEFAULT_ROOM_DIMENSIONS[t]);return A}function a(A,t,e){let i=new Float32Array(s.a.NUMBER_REVERB_FREQUENCY_BANDS);A=r(A),t=function(A){void 0==A&&(A={});for(let t in s.a.DEFAULT_ROOM_MATERIALS)A.hasOwnProperty(t)||(A[t]=s.a.ROOM_MATERIAL_COEFFICIENTS[s.a.DEFAULT_ROOM_MATERIALS[t]]);return A}(t),void 0==e&&(e=s.a.DEFAULT_SPEED_OF_SOUND);let n=s.a.TWENTY_FOUR_LOG10/e,o=A.width*A.height*A.depth;if(o<s.a.ROOM_MIN_VOLUME)return i;let a=A.width*A.height,h=A.width*A.depth,c=A.depth*A.height,_=2*(a+h+c);for(let r=0;r<s.a.NUMBER_REVERB_FREQUENCY_BANDS;r++){let A=((t.left[r]+t.right[r])*a+(t.down[r]+t.up[r])*h+(t.front[r]+t.back[r])*c)/_;i[r]=s.a.ROOM_EYRING_CORRECTION_COEFFICIENT*n*o/(-_*Math.log(1-A)+4*s.a.ROOM_AIR_ABSORPTION_COEFFICIENTS[r]*o)}return i}function h(A){let t=[];for(let e in s.a.DEFAULT_REFLECTION_COEFFICIENTS)if(s.a.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(e)){t[e]=0;for(let i=0;i<s.a.NUMBER_REFLECTION_AVERAGING_BANDS;i++){let n=i+s.a.ROOM_STARTING_AVERAGING_BAND;t[e]+=A[e][n]}t[e]/=s.a.NUMBER_REFLECTION_AVERAGING_BANDS,t[e]=Math.sqrt(1-t[e])}return t}function c(A,t){void 0==t&&(t={}),void 0==t.listenerPosition&&(t.listenerPosition=s.a.DEFAULT_POSITION.slice()),void 0==t.dimensions&&(t.dimensions={},Object.assign(t.dimensions,s.a.DEFAULT_ROOM_DIMENSIONS)),void 0==t.materials&&(t.materials={},Object.assign(t.materials,s.a.DEFAULT_ROOM_MATERIALS)),void 0==t.speedOfSound&&(t.speedOfSound=s.a.DEFAULT_SPEED_OF_SOUND),t.dimensions=r(t.dimensions);let e=o(t.materials),c=h(e),_=a(t.dimensions,e,t.speedOfSound);this.early=new n.a(A,{dimensions:t.dimensions,coefficients:c,speedOfSound:t.speedOfSound,listenerPosition:t.listenerPosition}),this.late=new i.a(A,{durations:_}),this.speedOfSound=t.speedOfSound,this.output=A.createGain(),this.early.output.connect(this.output),this._merger=A.createChannelMerger(4),this.late.output.connect(this._merger,0,0),this._merger.connect(this.output)}c.prototype.setProperties=function(A,t){let e=o(t),i=a(A,e,this.speedOfSound);this.late.setDurations(i),this.early.speedOfSound=this.speedOfSound;let n=h(e);this.early.setRoomProperties(A,n)},c.prototype.setListenerPosition=function(A,t,e){this.early.speedOfSound=this.speedOfSound,this.early.setListenerPosition(A,t,e);let i=this.getDistanceOutsideRoom(A,t,e),n=1;i>s.a.EPSILON_FLOAT&&(n=1-i/s.a.LISTENER_MAX_OUTSIDE_ROOM_DISTANCE,n=Math.max(0,Math.min(1,n))),this.output.gain.value=n},c.prototype.getDistanceOutsideRoom=function(A,t,e){let i=Math.max(0,-this.early._halfDimensions.width-A,A-this.early._halfDimensions.width),n=Math.max(0,-this.early._halfDimensions.height-t,t-this.early._halfDimensions.height),s=Math.max(0,-this.early._halfDimensions.depth-e,e-this.early._halfDimensions.depth);return Math.sqrt(i*i+n*n+s*s)},t.a=c},function(A,t,e){"use strict";var i=e(0);
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function n(A,t){void 0==t&&(t={}),void 0==t.durations&&(t.durations=i.a.DEFAULT_REVERB_DURATIONS.slice()),void 0==t.predelay&&(t.predelay=i.a.DEFAULT_REVERB_PREDELAY),void 0==t.gain&&(t.gain=i.a.DEFAULT_REVERB_GAIN),void 0==t.bandwidth&&(t.bandwidth=i.a.DEFAULT_REVERB_BANDWIDTH),void 0==t.tailonset&&(t.tailonset=i.a.DEFAULT_REVERB_TAIL_ONSET);let e=t.predelay/1e3;this._bandwidthCoeff=t.bandwidth*i.a.LOG2_DIV2,this._tailonsetSamples=t.tailonset/1e3,this._context=A,this.input=A.createGain(),this._predelay=A.createDelay(e),this._convolver=A.createConvolver(),this.output=A.createGain(),this.output.gain.value=t.gain,this._convolver.normalize=!1,this.input.connect(this._predelay),this._predelay.connect(this._convolver),this._convolver.connect(this.output),this.setDurations(t.durations)}n.prototype.setDurations=function(A){if(A.length!==i.a.NUMBER_REVERB_FREQUENCY_BANDS)return void i.a.log("Warning: invalid number of RT60 values provided to reverb.");let t=new Float32Array(i.a.NUMBER_REVERB_FREQUENCY_BANDS),e=this._context.sampleRate;for(let h=0;h<A.length;h++)A[h]=Math.max(0,Math.min(i.a.DEFAULT_REVERB_MAX_DURATION,A[h])),t[h]=Math.round(A[h]*e*i.a.DEFAULT_REVERB_DURATION_MULTIPLIER);let n=0;for(let i=0;i<t.length;i++)t[i]>n&&(n=t[i]);n<1&&(n=1);let s=this._context.createBuffer(1,n,e),o=s.getChannelData(0),r=new Float32Array(n);for(let i=0;i<n;i++)r[i]=2*Math.random()-1;for(let h=0;h<i.a.NUMBER_REVERB_FREQUENCY_BANDS;h++){let A=-i.a.LOG1000/t[h],n=i.a.TWO_PI*i.a.DEFAULT_REVERB_FREQUENCY_BANDS[h]/e,s=Math.sin(n),a=s*Math.sinh(this._bandwidthCoeff*n/s),c=1/(1+a),_=a*c,D=-2*Math.cos(n)*c,f=(1-a)*c,l=0,u=0;for(let e=0;e<t[h];e++){let t=r[e]*Math.exp(A*e)-D*l-f*u;o[e]+=_*(t-u),u=l,l=t}}let a=Math.round(this._tailonsetSamples);for(let h=0;h<Math.min(o.length,a);h++){let A=.5*(1-Math.cos(i.a.TWO_PI*h/(2*a-1)));o[h]*=A}this._convolver.buffer=s},t.a=n},function(A,t,e){"use strict";var i=e(0);
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function n(A,t){void 0==t&&(t={}),void 0==t.speedOfSound&&(t.speedOfSound=i.a.DEFAULT_SPEED_OF_SOUND),void 0==t.listenerPosition&&(t.listenerPosition=i.a.DEFAULT_POSITION.slice()),void 0==t.coefficients&&(t.coefficients={},Object.assign(t.coefficients,i.a.DEFAULT_REFLECTION_COEFFICIENTS)),this.speedOfSound=t.speedOfSound,this.input=A.createGain(),this.output=A.createGain(),this._lowpass=A.createBiquadFilter(),this._delays={},this._gains={},this._inverters={},this._merger=A.createChannelMerger(4);for(let e in i.a.DEFAULT_REFLECTION_COEFFICIENTS)i.a.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(e)&&(this._delays[e]=A.createDelay(i.a.MAX_DURATION),this._gains[e]=A.createGain());this._inverters.right=A.createGain(),this._inverters.down=A.createGain(),this._inverters.back=A.createGain(),this._lowpass.type="lowpass",this._lowpass.frequency.value=i.a.DEFAULT_REFLECTION_CUTOFF_FREQUENCY,this._lowpass.Q.value=0;for(let e in i.a.DEFAULT_REFLECTION_COEFFICIENTS)i.a.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(e)&&(this._delays[e].delayTime.value=0,this._gains[e].gain.value=0);this._inverters.right.gain.value=-1,this._inverters.down.gain.value=-1,this._inverters.back.gain.value=-1,this.input.connect(this._lowpass);for(let e in i.a.DEFAULT_REFLECTION_COEFFICIENTS)i.a.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(e)&&(this._lowpass.connect(this._delays[e]),this._delays[e].connect(this._gains[e]),this._gains[e].connect(this._merger,0,0));this._gains.left.connect(this._merger,0,1),this._gains.right.connect(this._inverters.right),this._inverters.right.connect(this._merger,0,1),this._gains.up.connect(this._merger,0,2),this._gains.down.connect(this._inverters.down),this._inverters.down.connect(this._merger,0,2),this._gains.front.connect(this._merger,0,3),this._gains.back.connect(this._inverters.back),this._inverters.back.connect(this._merger,0,3),this._merger.connect(this.output),this._listenerPosition=t.listenerPosition,this.setRoomProperties(t.dimensions,t.coefficients)}n.prototype.setListenerPosition=function(A,t,e){this._listenerPosition=[A,t,e];let n={left:i.a.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.width+A)+i.a.DEFAULT_REFLECTION_MIN_DISTANCE,right:i.a.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.width-A)+i.a.DEFAULT_REFLECTION_MIN_DISTANCE,front:i.a.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.depth+e)+i.a.DEFAULT_REFLECTION_MIN_DISTANCE,back:i.a.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.depth-e)+i.a.DEFAULT_REFLECTION_MIN_DISTANCE,down:i.a.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.height+t)+i.a.DEFAULT_REFLECTION_MIN_DISTANCE,up:i.a.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.height-t)+i.a.DEFAULT_REFLECTION_MIN_DISTANCE};for(let s in i.a.DEFAULT_REFLECTION_COEFFICIENTS)if(i.a.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(s)){let A=n[s]/this.speedOfSound;this._delays[s].delayTime.value=A;let t=this._coefficients[s]/n[s];this._gains[s].gain.value=t}},n.prototype.setRoomProperties=function(A,t){void 0==A&&(A={},Object.assign(A,i.a.DEFAULT_ROOM_DIMENSIONS)),void 0==t&&(t={},Object.assign(t,i.a.DEFAULT_REFLECTION_COEFFICIENTS)),this._coefficients=t,this._halfDimensions={},this._halfDimensions.width=.5*A.width,this._halfDimensions.height=.5*A.height,this._halfDimensions.depth=.5*A.depth,this.setListenerPosition(this._listenerPosition[0],this._listenerPosition[1],this._listenerPosition[2])},t.a=n},function(A,t,e){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var i=e(11),n=e(6),s=e(5),o=e(9),r=e(1),a=e(8),h=e(2),c=e(7),_=e(4),D=e(3),f=e(0),l=e(13);e.d(t,"ResonanceAudio",function(){return i.a}),
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
i.a.Attenuation=n.a,i.a.Directivity=s.a,i.a.EarlyReflections=o.a,i.a.Encoder=r.a,i.a.LateReflections=a.a,i.a.Listener=h.a,i.a.Room=c.a,i.a.Source=_.a,i.a.Tables=D,i.a.Utils=f.a,i.a.Version=l.a,t.default=i.a},function(A,t,e){"use strict";var i=e(2),n=e(4),s=e(7),o=e(1),r=e(0);
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */
function a(A,t){void 0==t&&(t={}),void 0==t.ambisonicOrder&&(t.ambisonicOrder=r.a.DEFAULT_AMBISONIC_ORDER),void 0==t.listenerPosition&&(t.listenerPosition=r.a.DEFAULT_POSITION.slice()),void 0==t.listenerForward&&(t.listenerForward=r.a.DEFAULT_FORWARD.slice()),void 0==t.listenerUp&&(t.listenerUp=r.a.DEFAULT_UP.slice()),void 0==t.dimensions&&(t.dimensions={},Object.assign(t.dimensions,r.a.DEFAULT_ROOM_DIMENSIONS)),void 0==t.materials&&(t.materials={},Object.assign(t.materials,r.a.DEFAULT_ROOM_MATERIALS)),void 0==t.speedOfSound&&(t.speedOfSound=r.a.DEFAULT_SPEED_OF_SOUND),this._ambisonicOrder=o.a.validateAmbisonicOrder(t.ambisonicOrder),this._sources=[],this._room=new s.a(A,{listenerPosition:t.listenerPosition,dimensions:t.dimensions,materials:t.materials,speedOfSound:t.speedOfSound}),this._listener=new i.a(A,{ambisonicOrder:t.ambisonicOrder,position:t.listenerPosition,forward:t.listenerForward,up:t.listenerUp}),this._context=A,this.output=A.createGain(),this.ambisonicOutput=A.createGain(),this.ambisonicInput=this._listener.input,this._room.output.connect(this._listener.input),this._listener.output.connect(this.output),this._listener.ambisonicOutput.connect(this.ambisonicOutput)}a.prototype.createSource=function(A){let t=new n.a(this,A);return this._sources[this._sources.length]=t,t},a.prototype.setAmbisonicOrder=function(A){this._ambisonicOrder=o.a.validateAmbisonicOrder(A)},a.prototype.setRoomProperties=function(A,t){this._room.setProperties(A,t)},a.prototype.setListenerPosition=function(A,t,e){this._listener.position[0]=A,this._listener.position[1]=t,this._listener.position[2]=e,this._room.setListenerPosition(A,t,e),this._sources.forEach(function(A){A._update()})},a.prototype.setListenerOrientation=function(A,t,e,i,n,s){this._listener.setOrientation(A,t,e,i,n,s)},a.prototype.setListenerFromMatrix=function(A){this._listener.setFromMatrix(A),this.setListenerPosition(this._listener.position[0],this._listener.position[1],this._listener.position[2])},a.prototype.setSpeedOfSound=function(A){this._room.speedOfSound=A},t.a=a},function(A,t,e){"use strict";
/**
 * @license
