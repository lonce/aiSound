...
//var AudioResourceManager = function (){
	...
	var resourceManager =  {
		...
		*/
		"loadAudioResource": function(i_url, i_usrOnLoad, context, i_alsoOnLoad){
				console.log("loadAudioResoure with i_url = " + i_url);
				...
				xhr.onload = function () {
					...
					context.decodeAudioData(xhr.response, onDecode, xhr.onerror);
				};
	...
	export default resourceManager.loadAudioResource
