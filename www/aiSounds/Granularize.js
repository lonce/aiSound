...
export default function (context=audioCtx) {
    ...
    var graph = null;
    var ephasor = makePhasor(); // triggers grains

    var m_grainRate=4; // frequency of grain generation
    var m_grainDuration=.5;  // seconds
    var m_grainStep=.25;  // seconds
	...
	myInterface.registerParam(
		...
		"range",
		{
			"min": 0,
			"max": 1,
			"val": m_pitchVariation
		},
		function (i_val) {
			m_pitchVariation = i_val;
		}
	);
