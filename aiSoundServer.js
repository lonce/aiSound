...
app.get(["/soundList", "/soundList/aisDescriptors"],function(req, res){
  var jsonObj;
  var jsonList=[];
  console.log("fetching from aisDescriptors");
    // get list of file names
    getFileList("./www/aisDescriptors", function (z, flist){ // TODO: The 1st arg should obviously be passed in as data from the client!
